    ...
    <form (ngSubmit)="submitFormHandler($event)">
      ...
      <div class="mb-2">
        <input
          ...
          (change)="PDF_PAGE_ORITENTATION = $event.target.value"
        />
      ...
      <div class="form-check">
        <input
          ...
          (change)="PDF_WITH_HEADER_IMAGE = $event.target.checked"
        />
      ...
      <div class="form-check">
        <input
          ...
          (change)="PDF_WITH_FOOTER_PAGE_COUNT = $event.target.checked"
        />
      ...
      <div class="my-2">
        <input
          ...
          (change)="PDF_HEADER_HEIGHT = parseInt($event.target.value)"
        />
      ...
      <div class="my-2">
        <input
          ...
          (change)="PDF_ROW_HEIGHT = parseInt($event.target.value)"
        />
      ...
      <div class="form-check">
        <input
          ...
          (change)="PDF_WITH_CELL_FORMATTING = $event.target.checked"
        />
      ...
      <div class="form-check">
        <input
          ...
          (change)="PDF_WITH_COLUMNS_AS_LINKS = $event.target.checked"
        />
      ...
      <div class="form-check">
        <input
          ...
          (change)="PDF_SELECTED_ROWS_ONLY = $event.target.checked"
        />
...
export class PDFExportPanel implements OnInit, AfterViewInit {
  @Input() agGridApi;
  @Input() agColumnApi;
